...
const CodeReviewerIcon = (props: React.SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path fillRule="evenodd" d="M3 6a3 3 0 013-3h12a3 3 0 013 3v12a3 3 0 01-3 3H6a3 3 0 01-3-3V6zm3 4.5a.75.75 0 000 1.5h.5a.75.75 0 000-1.5H6zm3 0a.75.75 0 000 1.5h8.5a.75.75 0 000-1.5H9zm-3 4.5a.75.75 0 000 1.5h.5a.75.75 0 000-1.5H6zm3 0a.75.75 0 000 1.5h5.5a.75.75 0 000-1.5H9z" clipRule="evenodd" /></svg>;
...
export const FEATURES = [
    { id: 'code-reviewer', title: 'Terminal Architect', description: 'Deep-dive code auditing and security analysis in a terminal interface.', icon: <CodeReviewerIcon />, category: 'Assist & Analyze' },
