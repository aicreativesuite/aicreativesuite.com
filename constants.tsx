...
const MessengerIcon = () => <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6"><path d="M12 2C6.48 2 2 6.145 2 11.259c0 2.912 1.455 5.516 3.732 7.215.17.127.276.331.263.544l-.169 2.018 2.11-1.165c.19-.105.416-.113.611-.022a9.793 9.793 0 003.453.63c5.514 0 10-4.145 10-9.259S17.514 2 12 2zm-1.292 11.34l-2.48-3.97-4.852 3.97 5.327-5.66 2.48 3.97 4.852-3.97-5.327 5.66z"/></svg>;
